...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 2: /* generic 'else' */
		...
		_m = 3; goto P999;
		 ...
		 /* PROC req_button */
	case 3: // STATE 1 - sec_env.pml:113 - [(!(floor_request_made[(_pid-4)]))] (0:0:0 - 1)
		IfNotBlocked
		reached[4][1] = 1;
		if (!( !(((int)now.floor_request_made[ Index((((int)((P4 *)_this)->_pid)-4), 4) ]))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 4: // STATE 2 - sec_env.pml:115 - [request!(_pid-4)] (0:0:0 - 1)
		IfNotBlocked
		reached[4][2] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 5: // STATE 3 - sec_env.pml:116 - [floor_request_made[(_pid-4)] = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[4][3] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 6: // STATE 8 - sec_env.pml:119 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[4][8] = 1;
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC req_handler */
	case 7: // STATE 1 - sec_env.pml:106 - [request?dest] (0:0:1 - 1)
		reached[3][1] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 8: // STATE 2 - sec_env.pml:106 - [go!dest] (0:0:0 - 1)
		IfNotBlocked
		reached[3][2] = 1;
		if (q_full(now.go))
			continue;
		...
		_m = 2; goto P999; /* 0 */
	case 9: // STATE 3 - sec_env.pml:106 - [served?1] (0:0:0 - 1)
		reached[3][3] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 10: // STATE 7 - sec_env.pml:108 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[3][7] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC main_control */
	case 11: // STATE 1 - sec_env.pml:67 - [current_floor = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[2][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 12: // STATE 2 - sec_env.pml:69 - [go?dest] (0:0:1 - 1)
		reached[2][2] = 1;
		if (q_zero(now.go))
		...
		_m = 4; goto P999; /* 0 */
	case 13: // STATE 3 - sec_env.pml:70 - [update_cabin_door!0] (0:0:0 - 1)
		IfNotBlocked
		reached[2][3] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 14: // STATE 4 - sec_env.pml:71 - [cabin_door_updated?0] (0:0:0 - 1)
		reached[2][4] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 15: // STATE 5 - sec_env.pml:73 - [((dest>current_floor))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][5] = 1;
		if (!((((int)((P2 *)_this)->dest)>((int)now.current_floor))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 16: // STATE 6 - sec_env.pml:74 - [direction = up] (0:0:1 - 1)
		IfNotBlocked
		reached[2][6] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 17: // STATE 7 - sec_env.pml:75 - [move!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][7] = 1;
		if (q_full(now.move))
			continue;
		...
		_m = 2; goto P999; /* 0 */
	case 18: // STATE 8 - sec_env.pml:76 - [floor_reached?1] (0:0:0 - 1)
		reached[2][8] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 19: // STATE 9 - sec_env.pml:77 - [current_floor = dest] (0:0:1 - 1)
		IfNotBlocked
		reached[2][9] = 1;
		(trpt+1)->bup.oval = ((int)now.current_floor);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 20: // STATE 10 - sec_env.pml:78 - [move!0] (0:0:0 - 1)
		IfNotBlocked
		reached[2][10] = 1;
		if (q_full(now.move))
			continue;
		...
		if (q_zero(now.move)) { boq = now.move; };
		_m = 2; goto P999; /* 0 */
	case 21: // STATE 11 - sec_env.pml:79 - [update_cabin_door!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][11] = 1;
		if (q_full(now.update_cabin_door))
			continue;
		...
		if (q_zero(now.update_cabin_door)) { boq = now.update_cabin_door; };
		_m = 2; goto P999; /* 0 */
	case 22: // STATE 12 - sec_env.pml:80 - [cabin_door_updated?1] (0:0:0 - 1)
		reached[2][12] = 1;
		if (q_zero(now.cabin_door_updated))
		{	if (boq != now.cabin_door_updated) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 23: // STATE 13 - sec_env.pml:81 - [((dest<current_floor))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][13] = 1;
		if (!((((int)((P2 *)_this)->dest)<((int)now.current_floor))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 24: // STATE 14 - sec_env.pml:82 - [direction = down] (0:0:1 - 1)
		IfNotBlocked
		reached[2][14] = 1;
		(trpt+1)->bup.oval = direction;
		direction = 3;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 25: // STATE 15 - sec_env.pml:83 - [move!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][15] = 1;
		if (q_full(now.move))
			continue;
		...
		if (q_zero(now.move)) { boq = now.move; };
		_m = 2; goto P999; /* 0 */
	case 26: // STATE 16 - sec_env.pml:84 - [floor_reached?1] (0:0:0 - 1)
		reached[2][16] = 1;
		if (q_zero(now.floor_reached))
		{	if (boq != now.floor_reached) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 27: // STATE 17 - sec_env.pml:85 - [current_floor = dest] (0:0:1 - 1)
		IfNotBlocked
		reached[2][17] = 1;
		(trpt+1)->bup.oval = ((int)now.current_floor);
		now.current_floor = ((int)((P2 *)_this)->dest);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 28: // STATE 18 - sec_env.pml:86 - [move!0] (0:0:0 - 1)
		IfNotBlocked
		reached[2][18] = 1;
		if (q_full(now.move))
			continue;
		...
		if (q_zero(now.move)) { boq = now.move; };
		_m = 2; goto P999; /* 0 */
	case 29: // STATE 19 - sec_env.pml:87 - [update_cabin_door!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][19] = 1;
		if (q_full(now.update_cabin_door))
			continue;
		...
		if (q_zero(now.update_cabin_door)) { boq = now.update_cabin_door; };
		_m = 2; goto P999; /* 0 */
	case 30: // STATE 20 - sec_env.pml:88 - [cabin_door_updated?1] (0:0:0 - 1)
		reached[2][20] = 1;
		if (q_zero(now.cabin_door_updated))
		{	if (boq != now.cabin_door_updated) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 31: // STATE 22 - sec_env.pml:90 - [direction = none] (0:0:1 - 1)
		IfNotBlocked
		reached[2][22] = 1;
		(trpt+1)->bup.oval = direction;
		direction = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 32: // STATE 23 - sec_env.pml:91 - [update_cabin_door!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][23] = 1;
		if (q_full(now.update_cabin_door))
			continue;
		...
		if (q_zero(now.update_cabin_door)) { boq = now.update_cabin_door; };
		_m = 2; goto P999; /* 0 */
	case 33: // STATE 24 - sec_env.pml:92 - [cabin_door_updated?1] (0:0:0 - 1)
		reached[2][24] = 1;
		if (q_zero(now.cabin_door_updated))
		{	if (boq != now.cabin_door_updated) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 34: // STATE 27 - sec_env.pml:96 - [assert(((0<=current_floor)&&(current_floor<4)))] (0:0:0 - 4)
		IfNotBlocked
		reached[2][27] = 1;
		spin_assert(((0<=((int)now.current_floor))&&(((int)now.current_floor)<4)), "((0<=current_floor)&&(current_floor<4))", II, tt, t);
		_m = 3; goto P999; /* 0 */
	case 35: // STATE 28 - sec_env.pml:97 - [floor_request_made[dest] = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[2][28] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 36: // STATE 29 - sec_env.pml:98 - [served!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][29] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 37: // STATE 33 - sec_env.pml:100 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[2][33] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
	...
	case 38: // STATE 1 - sec_env.pml:56 - [move?1] (0:0:0 - 1)
		reached[1][1] = 1;
		if (q_zero(now.move))
		...
		_m = 4; goto P999; /* 0 */
	case 39: // STATE 2 - sec_env.pml:58 - [move?0] (0:0:0 - 1)
		reached[1][2] = 1;
		if (q_zero(now.move))
		{	if (boq != now.move) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 40: // STATE 4 - sec_env.pml:59 - [floor_reached!1] (0:0:0 - 1)
		IfNotBlocked
		reached[1][4] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 41: // STATE 11 - sec_env.pml:62 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[1][11] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC cabin_door */
	case 42: // STATE 1 - sec_env.pml:48 - [update_cabin_door?1] (0:0:0 - 1)
		reached[0][1] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 43: // STATE 2 - sec_env.pml:48 - [floor_door_is_open[current_floor] = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[0][2] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 44: // STATE 3 - sec_env.pml:48 - [cabin_door_is_open = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[0][3] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 45: // STATE 4 - sec_env.pml:48 - [cabin_door_updated!1] (0:0:0 - 1)
		IfNotBlocked
		reached[0][4] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 46: // STATE 5 - sec_env.pml:49 - [update_cabin_door?0] (0:0:0 - 1)
		reached[0][5] = 1;
		if (q_zero(now.update_cabin_door))
		{	if (boq != now.update_cabin_door) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 47: // STATE 6 - sec_env.pml:49 - [cabin_door_is_open = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[0][6] = 1;
		(trpt+1)->bup.oval = ((int)cabin_door_is_open);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 48: // STATE 7 - sec_env.pml:49 - [floor_door_is_open[current_floor] = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[0][7] = 1;
		(trpt+1)->bup.oval = ((int)floor_door_is_open[ Index(((int)now.current_floor), 4) ]);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 49: // STATE 8 - sec_env.pml:49 - [cabin_door_updated!0] (0:0:0 - 1)
		IfNotBlocked
		reached[0][8] = 1;
		if (q_full(now.cabin_door_updated))
			continue;
		...
		if (q_zero(now.cabin_door_updated)) { boq = now.cabin_door_updated; };
		_m = 2; goto P999; /* 0 */
	case 50: // STATE 12 - sec_env.pml:51 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][12] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
