...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 2: /* generic 'else' */
		...
		_m = 3; goto P999;
		 ...
		 /* PROC req_button */
	case 3: // STATE 1 - sec_multi_env.pml:184 - [(!(floor_request_made[((_pid-(3*3))-1)]))] (0:0:0 - 1)
		IfNotBlocked
		reached[4][1] = 1;
		if (!( !(((int)now.floor_request_made[ Index(((((int)((P4 *)_this)->_pid)-(3*3))-1), 3) ]))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 4: // STATE 2 - sec_multi_env.pml:186 - [request!((_pid-(3*3))-1)] (0:0:0 - 1)
		IfNotBlocked
		reached[4][2] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 5: // STATE 3 - sec_multi_env.pml:187 - [floor_request_made[((_pid-(3*3))-1)] = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[4][3] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 6: // STATE 8 - sec_multi_env.pml:190 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[4][8] = 1;
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC req_handler */
	case 7: // STATE 1 - sec_multi_env.pml:175 - [request?dest] (0:0:1 - 1)
		reached[3][1] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 8: // STATE 2 - sec_multi_env.pml:175 - [go[k]!dest] (0:0:0 - 1)
		IfNotBlocked
		reached[3][2] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 9: // STATE 3 - sec_multi_env.pml:175 - [served[k]?1] (0:0:0 - 1)
		reached[3][3] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 10: // STATE 4 - sec_multi_env.pml:175 - [servedArr[k] = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[3][4] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 11: // STATE 5 - sec_multi_env.pml:175 - [requestProcessed[dest] = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[3][5] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 12: // STATE 6 - sec_multi_env.pml:175 - [k = ((k+1)%3)] (0:0:1 - 1)
		IfNotBlocked
		reached[3][6] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 13: // STATE 10 - sec_multi_env.pml:177 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[3][10] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC main_control */
	case 14: // STATE 1 - sec_multi_env.pml:113 - [current_floor[(_pid-(2*3))] = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[2][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 15: // STATE 2 - sec_multi_env.pml:115 - [go[(_pid-(2*3))]?destination] (0:0:1 - 1)
		reached[2][2] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 16: // STATE 3 - sec_multi_env.pml:116 - [update_cabin_door[(_pid-(2*3))]!0] (0:0:0 - 1)
		IfNotBlocked
		reached[2][3] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 17: // STATE 4 - sec_multi_env.pml:117 - [cabin_door_updated[(_pid-(2*3))]?0] (0:0:0 - 1)
		reached[2][4] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 18: // STATE 5 - sec_multi_env.pml:119 - [((destination>current_floor[(_pid-(2*3))]))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][5] = 1;
		if (!((((int)((P2 *)_this)->destination)>((int)now.current_floor[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 19: // STATE 6 - sec_multi_env.pml:120 - [directions[(_pid-(2*3))] = up] (0:0:1 - 1)
		IfNotBlocked
		reached[2][6] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 20: // STATE 7 - sec_multi_env.pml:121 - [move[(_pid-(2*3))]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][7] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 21: // STATE 8 - sec_multi_env.pml:122 - [floor_reached[(_pid-(2*3))]?1] (0:0:0 - 1)
		reached[2][8] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 22: // STATE 9 - sec_multi_env.pml:123 - [current_floor[(_pid-(2*3))] = destination] (0:0:1 - 1)
		IfNotBlocked
		reached[2][9] = 1;
		(trpt+1)->bup.oval = ((int)now.current_floor[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 23: // STATE 10 - sec_multi_env.pml:124 - [move[(_pid-(2*3))]!0] (0:0:0 - 1)
		IfNotBlocked
		reached[2][10] = 1;
		if (q_full(now.move[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]))
			continue;
		...
		if (q_zero(now.move[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ])) { boq = now.move[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]; };
		_m = 2; goto P999; /* 0 */
	case 24: // STATE 11 - sec_multi_env.pml:125 - [update_cabin_door[(_pid-(2*3))]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][11] = 1;
		if (q_full(now.update_cabin_door[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]))
			continue;
		...
		if (q_zero(now.update_cabin_door[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ])) { boq = now.update_cabin_door[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]; };
		_m = 2; goto P999; /* 0 */
	case 25: // STATE 12 - sec_multi_env.pml:126 - [cabin_door_updated[(_pid-(2*3))]?1] (0:0:0 - 1)
		reached[2][12] = 1;
		if (q_zero(now.cabin_door_updated[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]))
		{	if (boq != now.cabin_door_updated[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 26: // STATE 13 - sec_multi_env.pml:127 - [((destination<current_floor[(_pid-(2*3))]))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][13] = 1;
		if (!((((int)((P2 *)_this)->destination)<((int)now.current_floor[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 27: // STATE 14 - sec_multi_env.pml:128 - [directions[(_pid-(2*3))] = down] (0:0:1 - 1)
		IfNotBlocked
		reached[2][14] = 1;
		(trpt+1)->bup.oval = directions[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ];
		...
		;
		_m = 3; goto P999; /* 0 */
	case 28: // STATE 15 - sec_multi_env.pml:129 - [move[(_pid-(2*3))]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][15] = 1;
		if (q_full(now.move[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]))
			continue;
		...
		if (q_zero(now.move[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ])) { boq = now.move[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]; };
		_m = 2; goto P999; /* 0 */
	case 29: // STATE 16 - sec_multi_env.pml:130 - [floor_reached[(_pid-(2*3))]?1] (0:0:0 - 1)
		reached[2][16] = 1;
		if (q_zero(now.floor_reached[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]))
		{	if (boq != now.floor_reached[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 30: // STATE 17 - sec_multi_env.pml:131 - [current_floor[(_pid-(2*3))] = destination] (0:0:1 - 1)
		IfNotBlocked
		reached[2][17] = 1;
		(trpt+1)->bup.oval = ((int)now.current_floor[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]);
		now.current_floor[ Index((((P2 *)_this)->_pid-(2*3)), 3) ] = ((int)((P2 *)_this)->destination);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 31: // STATE 18 - sec_multi_env.pml:132 - [move[(_pid-(2*3))]!0] (0:0:0 - 1)
		IfNotBlocked
		reached[2][18] = 1;
		if (q_full(now.move[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]))
			continue;
		...
		if (q_zero(now.move[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ])) { boq = now.move[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]; };
		_m = 2; goto P999; /* 0 */
	case 32: // STATE 19 - sec_multi_env.pml:133 - [update_cabin_door[(_pid-(2*3))]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][19] = 1;
		if (q_full(now.update_cabin_door[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]))
			continue;
		...
		if (q_zero(now.update_cabin_door[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ])) { boq = now.update_cabin_door[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]; };
		_m = 2; goto P999; /* 0 */
	case 33: // STATE 20 - sec_multi_env.pml:134 - [cabin_door_updated[(_pid-(2*3))]?1] (0:0:0 - 1)
		reached[2][20] = 1;
		if (q_zero(now.cabin_door_updated[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]))
		{	if (boq != now.cabin_door_updated[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 34: // STATE 22 - sec_multi_env.pml:136 - [directions[(_pid-(2*3))] = none] (0:0:1 - 1)
		IfNotBlocked
		reached[2][22] = 1;
		(trpt+1)->bup.oval = directions[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ];
		...
		;
		_m = 3; goto P999; /* 0 */
	case 35: // STATE 23 - sec_multi_env.pml:137 - [update_cabin_door[(_pid-(2*3))]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][23] = 1;
		if (q_full(now.update_cabin_door[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]))
			continue;
		...
		if (q_zero(now.update_cabin_door[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ])) { boq = now.update_cabin_door[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]; };
		_m = 2; goto P999; /* 0 */
	case 36: // STATE 24 - sec_multi_env.pml:138 - [cabin_door_updated[(_pid-(2*3))]?1] (0:0:0 - 1)
		reached[2][24] = 1;
		if (q_zero(now.cabin_door_updated[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]))
		{	if (boq != now.cabin_door_updated[ Index((((int)((P2 *)_this)->_pid)-(2*3)), 3) ]) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 37: // STATE 27 - sec_multi_env.pml:147 - [floor_request_made[destination] = 0] (0:0:1 - 4)
		IfNotBlocked
		reached[2][27] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 38: // STATE 28 - sec_multi_env.pml:148 - [served[(_pid-(2*3))]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][28] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 39: // STATE 29 - sec_multi_env.pml:150 - [assert((current_floor[(_pid-(2*3))]==destination))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][29] = 1;
		...
		_m = 3; goto P999; /* 0 */
	case 40: // STATE 33 - sec_multi_env.pml:152 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[2][33] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
	...
	case 41: // STATE 1 - sec_multi_env.pml:92 - [move[(_pid-3)]?1] (0:0:0 - 1)
		reached[1][1] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 42: // STATE 2 - sec_multi_env.pml:94 - [move[(_pid-3)]?0] (0:0:0 - 1)
		reached[1][2] = 1;
		if (q_zero(now.move[ Index((((int)((P1 *)_this)->_pid)-3), 3) ]))
		{	if (boq != now.move[ Index((((int)((P1 *)_this)->_pid)-3), 3) ]) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 43: // STATE 4 - sec_multi_env.pml:95 - [floor_reached[(_pid-3)]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[1][4] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 44: // STATE 11 - sec_multi_env.pml:98 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[1][11] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC cabin_door */
	case 45: // STATE 1 - sec_multi_env.pml:84 - [update_cabin_door[_pid]?1] (0:0:0 - 1)
		reached[0][1] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 46: // STATE 2 - sec_multi_env.pml:84 - [floor_door_is_open[_pid].shaft[current_floor[_pid]] = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[0][2] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 47: // STATE 3 - sec_multi_env.pml:84 - [cabin_door_is_open[_pid] = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[0][3] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 48: // STATE 4 - sec_multi_env.pml:84 - [cabin_door_updated[_pid]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[0][4] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 49: // STATE 5 - sec_multi_env.pml:85 - [update_cabin_door[_pid]?0] (0:0:0 - 1)
		reached[0][5] = 1;
		if (q_zero(now.update_cabin_door[ Index(((int)((P0 *)_this)->_pid), 3) ]))
		{	if (boq != now.update_cabin_door[ Index(((int)((P0 *)_this)->_pid), 3) ]) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 50: // STATE 6 - sec_multi_env.pml:85 - [cabin_door_is_open[_pid] = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[0][6] = 1;
		(trpt+1)->bup.oval = ((int)cabin_door_is_open[ Index(((int)((P0 *)_this)->_pid), 3) ]);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 51: // STATE 7 - sec_multi_env.pml:85 - [floor_door_is_open[_pid].shaft[current_floor[_pid]] = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[0][7] = 1;
		(trpt+1)->bup.oval = ((int)now.floor_door_is_open[ Index(((int)((P0 *)_this)->_pid), 3) ].shaft[ Index(((int)now.current_floor[ Index(((int)((P0 *)_this)->_pid), 3) ]), 3) ]);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 52: // STATE 8 - sec_multi_env.pml:85 - [cabin_door_updated[_pid]!0] (0:0:0 - 1)
		IfNotBlocked
		reached[0][8] = 1;
		if (q_full(now.cabin_door_updated[ Index(((int)((P0 *)_this)->_pid), 3) ]))
			continue;
		...
		if (q_zero(now.cabin_door_updated[ Index(((int)((P0 *)_this)->_pid), 3) ])) { boq = now.cabin_door_updated[ Index(((int)((P0 *)_this)->_pid), 3) ]; };
		_m = 2; goto P999; /* 0 */
	case 53: // STATE 12 - sec_multi_env.pml:87 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][12] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
